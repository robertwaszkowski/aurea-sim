...
def run_demo_simulation(progress_callback, project_name_override: str = None):
    ...
    import time
    cb("[BRANDING] Generating project branding...")
    time.sleep(1.0)
    cb("[AI] Generating Base Prosimos Parameters...")
    time.sleep(0.5)
    cb("[AI] Connecting to Gemini API...")
    time.sleep(1.0)
    cb("[AI] Analyzing BPMN structure and node logic...")
    time.sleep(1.0)
    cb("[AI] Done! Base parameters saved.")
    time.sleep(0.5)
    cb("[AI] Designing realistic scenarios...")
    time.sleep(1.2)
    cb("[AI] Done! Experiment configuration saved.")
    time.sleep(0.5)
